...
from coursesmith.use_cases.create_course_outline.models.course_outline import (
    Quiz,
    Schedule,
)
...
class CreateDailyQuizTool(AgentTool[Schedule]):
    def __init__(
        self,
        llm_port: LlmPort,
    ...
    def name(self) -> str:
        return "create_daily_quiz"

    def description(self) -> str:
        return "Call this function to create a daily quiz"
